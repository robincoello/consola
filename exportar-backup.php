...
function crear_plugin($plugin) {
    crear_carpeta("../www/$plugin");
    crear_carpeta("../www/$plugin/controllers");
    crear_carpeta("../www/$plugin/models");
    crear_carpeta("../www/$plugin/views");
    crear_archivo("../www/$plugin/functions.php", contenido_functions($plugin));
    crear_archivo("../www/$plugin/readme.md", bdd_total_columnas_segun_tabla($plugin));
    ...
    foreach ($archivos as $archivo) {
        crear_archivo("../www/$plugin/controllers/$archivo", contenido_controllers($plugin, $archivo));
        crear_archivo("../www/$plugin/models/$archivo", $contenido);
        crear_archivo("../www/$plugin/views/$archivo", contenido_views($plugin, $archivo));
    }
}
